...
//instructions on the instructions state
//these are the main instructions for the game
...
//instructions for the sleep button
//tells you that the tamagotchi is not ready for bed
let sleepInstructions01 = `It's not time for bed yet. Your bedtime is at 9`;

//instructions for when its time for bed
let sleepInstructions02 = `Time for bed`;

//pet instructions on the pet me button in the living room
//explains how to pet the tamagotchi with handpose
